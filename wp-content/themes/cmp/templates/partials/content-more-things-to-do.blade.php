  ...
  <div class="activity-container">
      ...
      <div class="activity">
        ...
        <div class="activity__text-box">
          ...
          <p>Sleepovers, adults-only fun, stargazing, and more!</p>
        </div>
      ...
      <div class="activity">
        ...
        <div class="activity__text-box">
          ...
          <p>Dinosaurs and the art of Andy Warhol.
            Toss in a World War II submarine, original Monets
            and Degas, life-size casts of some of the world’s
            great architecture, and the largest exhibits dedicated
            to robots and the science of sports.
          </p>
        </div>
      ...
      <div class="activity">
        ...
        <div class="activity__text-box">
          ...
          <p>
            Some 22 million scientific specimens and 40,000
            art objects are the inspiration for our research,
      ...
      <div class="activity">
        ...
        <div class="activity__text-box">
          ...
          <p>Pack your bags and explore the world with Carnegie Museums experts.</p>
        </div>
