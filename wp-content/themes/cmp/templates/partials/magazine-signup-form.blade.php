...
<form name="survey_16543" method="GET" action="{{$subscribe_form_action}}">
  ...
  <input type="hidden" name="NEXTURL" value="http://members.carnegiemuseums.org/site/Survey?ACTION_REQUIRED=URI_ACTION_USER_REQUESTS&SURVEY_ID=16542#success" /><!--local page for successful submission redirect-->
